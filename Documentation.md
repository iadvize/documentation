...
| replies.payload | Typed payload of the message | Object | ✓ | replies.type == `message`, payload can be `text` or `card/content` |
| replies.quickReplies | Quick replies proposed to the visitor | Array |  | replies.type == `message`, elements must be `text/quick-reply` payloads|
