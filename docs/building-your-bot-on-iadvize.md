...
| List<br>(Nested paragraph)                 | 🔵 Partially    | `- First item\n    Nestesd paragraph`                                                                           | Indent with four spaces for nested paragraph. Line break is supported but not multiple paragraphs                                                                      |
| List<br>(Ordered)                          | 🟢 Yes          | `1. First item\n2. Second item\n 1. Sub item`                                                                   | Indent item for nested list                                                                                                                                            |
| List<br>(Tasks)                            | 🔵 Partially    | `- [x] Test Markdown`                                                                                           | Checkboxes are not readonly                                                                                                                                            |
